...
print('8 divided by 2 evaluates to:', 8/2)
...
#  the symbol ** is used to write "to the power of" (exponentiation)
###############################################################################
# DONE: 6.
...
# This is something the computer won't like
###############################################################################
# DONE: 8.
#   Uncomment the following and then run the program,
