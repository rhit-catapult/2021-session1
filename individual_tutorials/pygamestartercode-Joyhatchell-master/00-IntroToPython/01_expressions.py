...
###############################################################################
print("6+7 evaluates to:", 6+7)
print("12*4 evaluates to:", 12*4)
print("7-3 evaluates to:", 7-3)
print("5*4.0 evaluates to:", 5*4.0)
print()
print("_TODO 12:")
...
print("Joy" + "Hatchell")
print(("Joy" + "Hatchell likes candy ") * 3)
# + put the words next to each other and * multiplies the phrase
###############################################################################
# DONE: 15.
