...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            #          function and save the result into a variable called distance_from_center
            # DONE 5: If distance_from_center is less than or equal to circle_radius, set message_text to 'Bullseye!'
            #         If distance_from_center is greater than the circle_radius, set the message_text to 'You missed!'
