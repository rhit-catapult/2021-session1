...
mathy = 77 + math.cos(2.75)
print(math.sqrt(mathy))
...
math2 = (41 * 88) + (4 * math.cos(2))
print(math.sqrt(math2))
...
print(type('hello'))  # str
print(type("a b c"))  # str
print(type(3 + 3))  # int
print(type("3" + "3"))  # str
print(type(2 ** 100))  # int
print(type(2.0 ** 100))  # float
print(type(math.sin(8)))  # float
print(type(math.sin))  # function/method
print(type(print))  # function/method
