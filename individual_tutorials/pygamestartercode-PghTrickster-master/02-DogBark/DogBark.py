...
def main():
    ...
    while True:
        ...
        caption1 = font1.render("Two Dogs", True, BLACK, WHITE)
        ...
        caption2 = font2.render("Top Text", True , WHITE)
        screen.blit(caption2, (image1.get_width() // 2 - caption2.get_width() // 2, 0))
        # Update the screen
