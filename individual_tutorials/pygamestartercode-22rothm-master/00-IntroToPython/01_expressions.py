...
# two * means it is to the power of the following number
###############################################################################
# Done: 6.
...
print("_TODO 6:")
print("16+5 =", 16+5)
print(16+5, "- 200 =", 16+5-200)
print(16+5-200, "**2 =", (16+5-200)**2)
...
print("_TODO 12:")
print(286.0+425.0-5.0*3.0)
print("4.2 / 2.0 evaluates to:", 4.2 / 2.0)
print("4.2 / 2   evaluates to:", 4.2 / 2)
print("4 / 2     evaluates to:", 4 / 2)
print("3 / 2     evaluates to:", 3 / 2)
# Even though the division functions are of type int, the solution is of type float
###############################################################################
# done: 13.
#   Uncomment the following and then run the program,
#   paying close attention to what gets printed.
...
s = -9
# t = s / r
#        cant mathamaticaly /0
#y = "oops" + s
#       Cannont do string + int
#u = math.sqrt(-2)
#       Math domain error
v = (-2) ** 0.5
print(v)
