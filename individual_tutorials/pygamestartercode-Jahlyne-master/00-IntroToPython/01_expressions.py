...
print("20.5723 / 124.3512789 evaluates to:", 20.5723 / 124.3512789)
...
print()
print("_TODO 6:")
print("((4 * 2 ** 3) - 50) / 5 evaluates to:", ((4 * 2 ** 3) - 50) / 5)
print("46 ** 5908732 evaluates to:", 46 ** 5)
...
print()
print("_TODO 10:")
# print("'hello' / 'hi' evaluates to:", 'hello' / 'hi')
# print("30 / 0 evaluates to:", 30 / 0)
...
print()
print("_TODO 12:")
print("(30 + 23) * 5 evaluates:", (30 + 23) * 5)
print("(30 + 23.0) * 5 evaluates:", (30 + 23) * 5)
...
#   Uncomment the following and then run the program,
#   paying close attention to what gets printed.
#  // rounds down while % gives the remainder
...
print("17 % 5    evaluates to:", 17 % 5)
print("5 % 10 evaluates to:", 5 % 10)
print("20 // 5 evaluates to :", 20 // 5)
print("17 / 5 evaluates to:", 17 / 5)
