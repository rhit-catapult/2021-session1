...
class Raindrop:
    ...
    def move(self):
        ...
        self.y += self.speed
        # Same as self.y = self.y + self.speed
...
class Hero:
    def __init__(self, screen, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        self.x = x
        self.y = y
        self.image_with_umbrella = pygame.image.load("Mike_umbrella.png")
        self.image_without_umbrella = pygame.image.load("Mike.png")
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            # Put code here to do it once per event
