...
def main():
    ...
    while True:
        ...
        caption2 = font2.render("Sorry brother, but I love the human more, so it is time to be sacrificed", True, WHITE)
        screen.blit(caption2, (image1.get_width() // 2 - caption2.get_width() // 2, image1.get_height() // 2 - caption2.get_height() // 2))
