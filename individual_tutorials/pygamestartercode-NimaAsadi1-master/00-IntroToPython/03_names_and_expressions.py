...
###############################################################################
print("77+.cosine of 2.75 evaluates to:", 77 + math.cos(2.75))
###############################################################################
# DONE: 3.
...
#   Run your code (fix errors as needed), then change the above _TODO_ to DONE.
###############################################################################
print("the square root of ((41 * 88) + (4 * the cosine of 2)) evaluates as:", 41 * 88 + 4 * math.cos(2))
###############################################################################
# DONE: 4.
...
#   Run your code (fix errors as needed), then change the above _TODO_ to DONE.
###############################################################################
print("square root of 2 evaluates as:", math.sqrt(2))
print("square root of 2 evaluates as:", 2 ** 0.5)
###############################################################################
# DONE: 5.
