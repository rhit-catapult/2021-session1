...
class Game:
    ...
    def __repr__(self):
        ...
        return "Board: turn_counter: {}, game_state: {}".format(self.board, self.turn_counter, self.game_state_string)
    ...
    def check_for_game_over(self):
        ...
        for line in lines:
            if line == "XXX":
                # X has won the game
                self.game_state_string = "X Won"
                self.game_is_over = True
                pygame.mixer.music.play()
                return
            if line == "OOO":
                # O has won the game
                self.game_state_string = "O Won"
                self.game_is_over = True
                pygame.mixer.music.play()
                return
