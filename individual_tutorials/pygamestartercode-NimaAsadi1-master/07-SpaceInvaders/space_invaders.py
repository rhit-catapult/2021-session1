...
class Missile:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (150, 100, 200), (self.x, self.y), (self.x, self.y + 8), 4)
...
class Scoreboard:
    ...
    def draw(self):
        ...
        score_image = self.font.render(score_string, True, (150, 100, 200))
...
def main():
    ...
    while True:
        ...
        if pressed_keys[pygame.K_LEFT] and fighter.x > -fighter.image.get_width() / 2: fighter.x -= 5
        if pressed_keys[pygame.K_RIGHT] and fighter.x < screen.get_width() - fighter.image.get_width() / 2: fighter.x += 5
        # Use the SUPERGUN!!!!!!!!!!!!!!!!!!!!
