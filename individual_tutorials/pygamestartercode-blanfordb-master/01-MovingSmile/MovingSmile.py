...
def main():
    ...
    while True:
        # TODOne 4: Set the clock speed to 60 fps
        clock.tick(60)
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            # TODOne 3: Make the eye pupils move with Up, Down, Left, and Right keys
