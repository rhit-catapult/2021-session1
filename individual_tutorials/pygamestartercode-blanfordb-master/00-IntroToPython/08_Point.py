...
# -----------------------------------------------------------------------------
# TODOne: 2. With your instructor, implement a class called   Point
...
class Point(object):
    def __init__(self, x, y):
        ...
        self.y = y
    def __repr__(self):
        representation = "Point({}, {})".format(self.x, self.y)
...
def run_test_init():
    ...
    """
    # -------------------------------------------------------------------------
    # TODOne: 3.  With your instructor, READ and UNDERSTAND the instructions
...
def run_test_repr():
    ...
    """
    # -------------------------------------------------------------------------
    # TODOne: 4.  Follow the same instructions as in _TODO_3 above,
...
def run_test_clone():
   ...
   """
    # -------------------------------------------------------------------------
    # TODOne: 5.  Follow the same instructions as in _TODO_3 above,
