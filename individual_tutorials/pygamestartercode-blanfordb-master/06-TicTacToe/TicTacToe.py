...
class Game:
    def __init__(self):
        # TODOne 5: Create an empty board, called board
    ...
    def __repr__(self):
        ...
        # TODOne 7: Use a "".format() command to create a string to shows the board, turn_counter, and game_state_string
        return "Board: {}, turn_counter: {}, game_state: {}"\
            .format(self.board, self.turn_counter, self.game_state_string)

    def take_turn(self, row, col):
        """Handle the current turn of the player and update board array"""
        # TODOne 8: Check if game_is_over and return from this method (doing nothing) if True
        if self.game_is_over:
            print("Game is over, no more turns")
            return
        # TODOne 9: Check if the value for row and col are valid.  Return (doing nothing) if invalid.
        if row < 0:
            print("Invalid row")
            return
        if col < 0:
        ...
        if col > 2:
            print("Invalid column")
            return
        # TODOne 10: Check if the mark at the requested row col is ".".  Return (doing nothing) if it is not "."
        if self.board[row][col] != ".":
            print("Not empty location")
            return
        # TODOne 11: Determine if it is X's turn or O's turn (even turn_counter means X's turn, odd for O's turn)
        ...
        if self.game_state_string == "X's Turn":
            ...
            self.game_state_string = "X's Turn"
        # TODOne 12: Increment the turn_counter
        self.turn_counter += 1
        self.check_for_game_over()

    def check_for_game_over(self):
        # TODOne 18: If the turn_counter is 9 then the game is over
        ...
        # TODOne 19: Use the lines list to determine if there is a winner.
...
class ViewController:
    ...
    def __init__(self, screen):
        ...
        # TODOne 4: Initialize the ViewController, as follows:
        #     - Store the screen.
    ...
    def check_event(self, event):
        ...
        # TODOne 16: If the event is pygame.MOUSEBUTTONUP
        ...
        # TODOne 17: If the event is pygame.KEYDOWN
    ...
    def draw(self):
        ...
        # TODOne 13: Blit the board_image onto the screen at the x y position of row=0 col=0
        self.screen.blit(self.board_image, get_xy_position(0, 0))
        # TODOne 14: Use a nested loop (via range) to go over all marks of the game.board
        ...
        while row < 3:
            ...
            while col < 3:
                ...
                col += 1
            row += 1
        # TODOne 15: Update the display caption to be the game.game_state_string
...
def main():
    ...
    # TODOne 1: Create an instance of the ViewController class called view_controller
    view_controller = ViewController(screen)
    # TODOne 6: Write test code as needed to develop your model object.
    print(view_controller.game)
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            # TODOne 2: Pass the event to the view_controller
            view_controller.check_event(event)
        screen.fill(pygame.Color("white"))
        # TODOne 3: Draw the view_controller
